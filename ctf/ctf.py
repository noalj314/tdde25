...
def main_game(score=[]):
    ...
    def update_ui():
        ...
        for i in range(len(tanks_list)):
            ...
            menu.text_creator(screen, 20, 'Score ' + str(tanks_list[i].score), 0x000000, (place.x + 10, place.y + 30))
            menu.text_creator(screen, 20, 'Dmg ' + str(tanks_list[i].damage), 0x000000, (place.x + 10, place.y + 50))
            menu.text_creator(screen, 20, 'Fire Rate ' + str(tanks_list[i].fire_rate) + "/s", 0x000000, (place.x + 10, place.y + 70))
            menu.text_creator(screen, 20, 'Speed ' + str(tanks_list[i].max_speed), 0x000000, (place.x + 10, place.y + 90))
            menu.text_creator(screen, 20, 'Bullet Speed ' + str(tanks_list[i].bullet_speed), 0x000000, (place.x + 10, place.y + 110))
